...
## 1. Purpose
Automates the retrieval and parsing of Jira issues from the **DEVOPS** project. This skill ensures that technical data (Acceptance Criteria) and custom metadata (HuLoop Customer) are extracted and translated back into human-readable text for the Definition of Done (DoD) interview.
...
- **fields**: `summary,description,customfield_10037,customfield_10962`

### Step 2: Extraction & Translation
Extract the following fields from the JSON response:
- **Summary**: `fields.summary`
- **Description**: `fields.description`
- **Acceptance Criteria**: `fields.customfield_10037` (Translate from ADF or raw string to plain text)
- **HuLoop Customer**: 
    - Access `fields.customfield_10962`.
    - Map the `value` property of the items in the array (e.g., `[{"value": "Clutch"}]` → "Clutch").
...
- **Field IDs**: 
    - Acceptance Criteria: `customfield_10037`
    - Customer: `customfield_10962`
- **Null Handling**: If `customfield_10037` is empty, flag this and initiate a DoD interview via `AskUserQuestion`.
