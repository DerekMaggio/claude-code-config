...
- Show proposed commit message:
  - Format: `fix(ansible): <description> [DEVOPS-1587]`
...
Iteration N/M:
  ...
  Root Cause: replace_cacerts - /opt/huloop/test-cacerts missing

  Proposed Fix:
    File: ansible/roles/controller/workspace/tasks/main.yml
    Change: Add task to create dummy cacerts if not provided
