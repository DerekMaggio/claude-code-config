...
**Base Path:** `{vault_path}/Documents/Tech Docs/install4j/`
...
2. **Grep Search:** Execute: `Grep pattern="keyword" path="{vault_path}/Documents/Tech Docs/install4j/Source Docs/"`
